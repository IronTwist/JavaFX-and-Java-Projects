...
//        IRepository<Reservation> reservationIRepository = new InMemoryRepository<>();
        ...
        IRepository<Movie> movieIRepository = new JSONFileRepository<>("movies.txt", Movie.class);
        IRepository<Reservation> reservationIRepository = new JSONFileRepository<>("reservations.txt", Reservation.class);
